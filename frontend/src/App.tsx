    ...
    <div className="min-h-screen bg-base-100">
      ...
      <div className="navbar bg-base-200">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost text-xl">Log IS</a>
        </div>
      ...
      <footer className="footer p-10 bg-neutral text-neutral-content">
        ...
        <nav>
          ...
          <a className="link link-hover">AirTrack Pro</a> 
          <a className="link link-hover">ProcessFlow</a> 
          <a className="link link-hover">ArmsVault</a> 
        </nav> 
        <nav>
